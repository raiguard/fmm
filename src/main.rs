...
const HELP: &str = "usage: fmm [options] <operation>
operations:
...
options:
    --all              when using the clean operation, remove all non-symlink mods
    ...
    --nodisable -d     when using sync operations, keep current mods enabled
